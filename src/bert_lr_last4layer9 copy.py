...
class bert_lr_last4layer_Config(nn.Module):
    def __init__(self):
        self.bert_path = "/data/fuwen/SuWen/Bert-classification/chinese-bert-wwm"
        self.config_path = "/data/fuwen/SuWen/Bert-classification/chinese-bert-wwm/config.json"
        ...
        self.mytrainedmodel = "/data/fuwen/SuWen/Bert-classification/result/bert_clf_model.bin"
        """
