...
from bert_lr_last4layer import bert_lr_last4layer, bert_lr_last4layer_Config
...
class transformers_bert_binary_classification(object):
    ...
    def train_an_epoch(self, iterator):
        ...
        for i, batch in enumerate(iterator):
            ...
            loss = self.criterion(y_pred_prob.view(-1, 6), label.view(-1))  # 多分类改这里
            # loss = output[0]
            # 计算acc
...
if __name__ == '__main__':
    ...
    classifier.train(5)
    print("model saving...")
    torch.save(classifier, '../result/classifier6')
    print("model saved")
