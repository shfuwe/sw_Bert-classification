...
if __name__ == '__main__':
    ...
    print(predictor.predict("交通不好"))  # 0
    print(predictor.predict("这个书不推荐看"))  # 0
    print(predictor.predict("交通挺好的"))  # 1
    print(predictor.predict("这个衣服很漂亮"))  # 1
    print(predictor.predict("酒店的服务人员服务周到，细致，给人一种宾至如归的感觉"))  # 1